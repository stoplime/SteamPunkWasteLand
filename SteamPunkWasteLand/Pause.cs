...
namespace SteamPunkWasteLand
{
	public class Pause
	{
		...
		public Pause ()
		{
			...
			shopDescription [3, 2] = new Text (70 + X, 273 + Y, 250f, 26f, -1, -1, "Sec/Fire: " + Game.Upgrades [1, 2] + " → " + upgradedValue [2]);
		...
		public void Update (GamePadData gpd)
		{
			if (Game.Player1.Hp > 0) {
				...
				if (isSettings) {
					...
					shopDescription [3, 2].Update ("Sec/Fire: " + Game.Upgrades [1, 2] + " → " + upgradedValue [2]);
